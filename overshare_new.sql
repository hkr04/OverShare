/*
 ...
 Source Schema         : overshare

 Target Server Type    : MySQL
 Target Server Version : 80037
 File Encoding         : 65001

 Date: 09/06/2024 11:39:58
*/
...
CREATE TABLE `activity`  (
  ...
  `end` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '竞赛结束时间',
...
CREATE TABLE `activity_sign`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 44 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '活动报名表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `activity_sign` VALUES (43, 15, 15, '2024-06-09 00:03:28');
...
CREATE TABLE `blog`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 51 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '博客信息' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `blog` VALUES (49, '333', '', '3333', 'http://localhost:9091/files/1717903746455-1717834341514-src=http___gips0.baidu.com_it_u=3712921449,1137061177&fm=3030&app=3030&f=JPEG_w=200&h=133&s=8130CC3287405D410AF5B5C30300C0B2&refer=http___www.baidu.webp', '[\"绘画\"]', 14, '2024-06-08', 386, 1, 13);
INSERT INTO `blog` VALUES (50, '互联网+招募', '<p>团队介绍</p><p>需求</p>', '互联网+招募', 'http://localhost:9091/files/1717903726429-1717837652560-7ef360eb-e943-437b-9deb-53992d40a526.jpg', '[]', 14, '2024-06-08', 184, 1, 14);
...
CREATE TABLE `category`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '博客分类' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `certification`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 27 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '认证信息' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `circulars`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 18 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '系统通知表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `collect`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 72 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '收藏' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `comment`  (
  ...
  `module` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '模块',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 107 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '评论表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `likes`  (
  ...
  `module` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '模块',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 107 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '点赞' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `likes` VALUES (106, 49, 15, '帖子');
