...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'blog', name: 'Blog', meta: { name: '文化创意作品信息' }, component: () => import('../views/manager/Blog') },
      ...
      { path: 'certification', name: 'Certification', meta: { name: '创作者认证' }, component: () => import('../views/manager/Certification.vue') },
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'blogDetail', name: 'BlogDetail', meta: { name: '文化创意作品详情' }, component: () => import('../views/front/BlogDetail') },
      { path: 'search', name: 'Search', meta: { name: '搜索' }, component: () => import('../views/front/Search') },
      { path: 'newBlog', name: 'NewBlog', meta: { name: '发布作品' }, component: () => import('../views/front/NewBlog') },
      { path: 'signIn', name: 'SignIn', meta: { name: '签到' }, component: () => import('../views/front/SignIn.vue') },
      { path: 'certification', name: 'Certification', meta: { name: '创作者认证' }, component: () => import('../views/front/Certification.vue') },
      ...
      { path: 'exitHomePage', name: 'ExitHomePage', meta: { name: '编辑主页' }, component: () => import('../views/front/ExitHomePage.vue') },
