...
CREATE TABLE `activity_sign` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=53 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='活动报名表';

-- ----------------------------
-- Records of activity_sign
-- ----------------------------
INSERT INTO `activity_sign` VALUES ('51', '1', '14', '2024-06-10 11:00:45');
...
INSERT INTO `blog` VALUES ('50', '互联网+招募', '<p>团队介绍</p><p>需求</p>', '互联网+招募', 'http://localhost:9091/files/1717837652560-7ef360eb-e943-437b-9deb-53992d40a526.jpg', '[]', '14', '2024-06-08', '187', '1', '1');
