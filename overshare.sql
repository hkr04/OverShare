...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='活动';

-- ----------------------------
-- Records of activity
-- ----------------------------
INSERT INTO `activity` VALUES ('1', '中国“互联网+”创新创业大赛', '中国“互联网+”大学生创新创业大赛，由教育部与政府、各高校共同主办的一项技能大赛。大赛旨在深化高等教育综合改革，激发大学生的创造力，培养造就“大众创业、万众创新”的主力军；推动赛事成果转化，促进“互联网+”新业态形成，服务经济提质增效升级；以创新引领创业、创业带动就业，推动高校毕业生更高质量创业就业。', '', '2024-06-08', '2024-06-30', '线上', 'https://cy.ncss.cn/', '教育部', '18', 'http://localhost:9091/files/1717823187804-7ef360eb-e943-437b-9deb-53992d40a526.jpg');
INSERT INTO `activity` VALUES ('15', '“挑战杯”全国大学生课外学术科技作品竞赛', '挑战杯是“挑战杯”全国大学生系列科技学术竞赛的简称，是由共青团中央、中国科协、教育部和全国学联、举办地人民政府共同主办的全国性的大学生课外学术实践竞赛。“挑战杯”竞赛在中国共有两个并列项目，一个是“挑战杯”中国大学生创业计划竞赛；另一个则是“挑战杯”全国大学生课外学术科技作品竞赛。这两个项目的全国竞赛交叉轮流开展，每个项目每两年举办一届，“挑战杯”系列竞赛被誉为中国大学生学生科技创新创业的“奥林匹克”盛会，是国内大学生最关注最热门的全国性竞赛，也是全国最具代表性、权威性、示范性、导向性的大学生竞赛，“挑战杯”的杯名由原中共中央总书记、国家主席、中央军委主席江泽民同志亲自题写。', '<p>“挑战杯”全国大学生课外学术科技作品竞赛是一项全国性的竞赛活动，简称“大挑”（与挑战杯创业计划大赛对应）。该比赛创办于1986年，由教育部、共青团中央、中国科学技术协会、<a href=\"https://baike.baidu.com/item/%E4%B8%AD%E5%8D%8E%E5%85%A8%E5%9B%BD%E5%AD%A6%E7%94%9F%E8%81%94%E5%90%88%E4%BC%9A/4677647?fromModule=lemma_inlink\" target=\"_blank\">中华全国学生联合会</a>、省级人民政府主办，承办高校为国内<a href=\"https://baike.baidu.com/item/%E8%91%97%E5%90%8D%E5%A4%A7%E5%AD%A6/9266985?fromModule=lemma_inlink\" target=\"_blank\">著名大学</a>，“挑战杯”系列竞赛被誉为中国大学生学术科技“奥林匹克”，是国内大学生最关注最热门的全国性竞赛，也是全国最具<a href=\"https://baike.baidu.com/item/%E4%BB%A3%E8%A1%A8%E6%80%A7/22482495?fromModule=lemma_inlink\" target=\"_blank\">代表性</a>、权威性、示范性、导向性的大学生竞赛。该竞赛每两年举办一次，旨在鼓励大学生勇于创新、迎接挑战的精神，培养跨世纪<a href=\"https://baike.baidu.com/item/%E5%88%9B%E6%96%B0%E4%BA%BA%E6%89%8D/2788668?fromModule=lemma_inlink\" target=\"_blank\">创新人才</a>。<br/></p>', '2024-06-15', '2024-06-25', '线上', 'https://www.tiaozhanbei.net/', '共青团中央、中国科协、教育部和全国学联、举办地人民政府', '4', 'http://localhost:9091/files/1717834341514-src=http___gips0.baidu.com_it_u=3712921449,1137061177&fm=3030&app=3030&f=JPEG_w=200&h=133&s=8130CC3287405D410AF5B5C30300C0B2&refer=http___www.baidu.webp');
...
CREATE TABLE `activity_sign` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=42 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='活动报名表';
...
INSERT INTO `activity_sign` VALUES ('41', '14', '14', '2024-06-08 17:30:41');
...
INSERT INTO `blog` VALUES ('49', '333', '', '3333', null, '[\"绘画\"]', '14', '2024-06-08', '385', '1', '13');
INSERT INTO `blog` VALUES ('50', '互联网+招募', '<p>团队介绍</p><p>需求</p>', '互联网+招募', null, '[]', '14', '2024-06-08', '182', '1', '14');
...
CREATE TABLE `collect` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=72 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='收藏';
...
INSERT INTO `collect` VALUES ('64', '12', '14', '活动');
INSERT INTO `collect` VALUES ('65', '43', '14', '作品');
INSERT INTO `collect` VALUES ('70', '50', '14', '帖子');
...
CREATE TABLE `comment` (
  ...
  `module` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '模块',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=107 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='评论表';
...
INSERT INTO `comment` VALUES ('104', '111', '14', null, '104', '2024-06-08 12:16:17', '49', '作品');
INSERT INTO `comment` VALUES ('105', '期待！', '14', null, '105', '2024-06-08 14:30:53', '14', '活动');
INSERT INTO `comment` VALUES ('106', '111', '14', null, '106', '2024-06-08 15:42:26', '50', '作品');
...
CREATE TABLE `homepage` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='创作者个人主页';
...
CREATE TABLE `likes` (
  ...
  `module` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '模块',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=106 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='点赞';
...
INSERT INTO `likes` VALUES ('92', '12', '14', '活动');
INSERT INTO `likes` VALUES ('93', '43', '14', '作品');
INSERT INTO `likes` VALUES ('95', '49', '14', '作品');
INSERT INTO `likes` VALUES ('103', '50', '14', '帖子');
INSERT INTO `likes` VALUES ('105', '14', '14', '竞赛');
...
CREATE TABLE `user` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='用户信息';
...
INSERT INTO `user` VALUES ('14', 'test', '123', 'test', null, 'USER', null, null, null, null, null, '10');
